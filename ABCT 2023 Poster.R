...
model <- '
  ...
  POST_UPPS_NegativeUrgency_Total ~ 1 + T6 DTS_Total + POST_DASS_Total + POST_PANAS_NA_Total + DEMO_Race + DEMO_Gender + Condition
  ...
  FU_DTS_Total ~ 1 + POST_UPPS_Negative_Urgency_Total + FU_DASS_Total + FU_PANAS_NA_Total + DEMO_Race + DEMO_Gender + Condition
